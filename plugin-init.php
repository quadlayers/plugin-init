...
define( 'QLXXX_DEMO_URL', 'https://quadlayers.com/demo/plugin-init/?utm_source=plugin-init_admin' );
define( 'QLXXX_PURCHASE_URL', 'https://quadlayers.com/portfolio/plugin-init/?utm_source=plugin-init_admin' );
define( 'QLXXX_SUPPORT_URL', 'https://quadlayers.com/account/support/?utm_source=plugin-init_admin' );
define( 'QLXXX_DOCUMENTATION_URL', 'https://quadlayers.com/documentation/plugin-init/?utm_source=plugin-init_admin' );
define( 'QLXXX_DOCUMENTATION_API_URL', 'https://quadlayers.com/documentation/plugin-init/api/?utm_source=plugin-init_admin' );

...
if ( class_exists( 'QuadLayers\\WP_Notice_Plugin_Promote\\Load' ) ) {
	...
	define( 'QLXXX_PROMOTE_PREMIUM_INSTALL_URL', 'https://quadlayers.com/product/plugin-init/?utm_source=qlxxx_admin' );
	...
	new \QuadLayers\WP_Notice_Plugin_Promote\Load(
		...
		array(
			array(
				...
				'notice_description' => esc_html__( 'Could you please give it a 5-star rating on WordPress? Your feedback boosts our motivation, helps us promote, and continues to improve this product. Your support matters!', 'plugin-init' ),

...
if ( class_exists( 'QuadLayers\\WP_Notice_Plugin_Promote\\Load' ) ) {
	 ...
	 * Notice review
	 */
	define( 'QLXXX_PROMOTE_REVIEW_URL', 'https://wordpress.org/support/plugin/plugin-init/reviews/?filter=5#new-post' );
	/**
	 * Notice premium sell
	 */
	define( 'QLXXX_PROMOTE_PREMIUM_SELL_SLUG', 'plugin-init-pro' );
	define( 'QLXXX_PROMOTE_PREMIUM_SELL_NAME', 'Perfect WooCommerce Brands PRO' );
	define( 'QLXXX_PROMOTE_PREMIUM_INSTALL_URL', 'https://quadlayers.com/product/plugin-init/?utm_source=pwb_admin' );
	...
	define( 'QLXXX_PROMOTE_CROSS_INSTALL_1_DESCRIPTION', esc_html__( 'This plugin allows you to add custom fields to the checkout page, related to billing, shipping or additional fields sections.', 'plugin-init' ) );
	define( 'QLXXX_PROMOTE_CROSS_INSTALL_1_URL', 'https://quadlayers.com/portfolio/woocommerce-checkout-manager/?utm_source=pwb_admin' );
	/**
	 * Notice cross sell 2
	 */
	...
	define( 'QLXXX_PROMOTE_CROSS_INSTALL_2_DESCRIPTION', esc_html__( 'It allows you to reduce the steps in the checkout process by skipping the shopping cart page. This can encourage buyers to shop more and quickly. You will increase your sales reducing cart abandonment.', 'plugin-init' ) );
	define( 'QLXXX_PROMOTE_CROSS_INSTALL_2_URL', 'https://quadlayers.com/portfolio/woocommerce-direct-checkout/?utm_source=pwb_admin' );
	...
	new \QuadLayers\WP_Notice_Plugin_Promote\Load(
		...
		array(
			array(
				...
				'notice_description' => esc_html__( 'Could you please give it a 5-star rating on WordPress?. Your feedback will boost our motivation and help us promote and continue to improve this product.', 'plugin-init' ),
